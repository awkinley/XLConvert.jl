...
function get_type(idx::FlatIdx, parts::FlatExpr, current_sheet, cell_types, key_values)
    function c(e)
        if e isa FlatIdx
            get_type(e, parts, current_sheet, cell_types, key_values)
        else
            get_type(e, current_sheet, cell_types, key_values)
        end
    end

    expr = parts.parts[idx.i]
...
function get_type(expr::FlatExpr, current_sheet, cell_types, key_values)
    get_type(FlatIdx(1), expr::FlatExpr, current_sheet, cell_types, key_values)
end
